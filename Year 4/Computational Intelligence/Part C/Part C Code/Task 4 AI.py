...
test_path= spio.loadmat('D4(1).mat', squeeze_me=True)
...
power_spectrum = spio.loadmat('D4(1).mat', squeeze_me=True)['d']
...
spio.savemat('D4.mat', mdict={'d': initial_test_signal, 'Index': Test_IndexVal, 'Class': Neuron_Class})
