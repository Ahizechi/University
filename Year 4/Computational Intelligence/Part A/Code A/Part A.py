...
train_data = numpy.loadtxt("D:\\University\\Year 4\\EE40098\\MNIST\\mnist_train_100.csv", delimiter=",")
test_data = numpy.loadtxt("D:\\University\\Year 4\\EE40098\\MNIST\\mnist_test_10.csv", delimiter=",") 
...
ANN = NeuralNetwork(no_of_in_nodes = image_pixels, no_of_out_nodes = 10,  no_of_hidden_nodes = 200, learning_rate = 0.05)
