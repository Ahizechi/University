...
(cl:defmethod first-val ((m <AddTwoInts-request>))
...
(cl:ensure-generic-function 'tenth-val :lambda-list '(m))
(cl:defmethod tenth-val ((m <AddTwoInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader beginner_tutorials-srv:tenth-val is deprecated.  Use beginner_tutorials-srv:tenth instead.")
  (tenth m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <AddTwoInts-request>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'tenth))))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <AddTwoInts-request>) istream)
  "Deserializes a message object of type '<AddTwoInts-request>"
    ...
    (cl:setf (cl:slot-value msg 'tenth) (roslisp-utils:decode-double-float-bits bits)))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<AddTwoInts-request>)))
  ...
  "70e914cd01f6d2dbd6db72500ab2b805")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'AddTwoInts-request)))
  "Returns md5sum for a message object of type 'AddTwoInts-request"
  "70e914cd01f6d2dbd6db72500ab2b805")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AddTwoInts-request>)))
  ...
  (cl:format cl:nil "string first~%float64 tenth~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AddTwoInts-request)))
  "Returns full string definition for message of type 'AddTwoInts-request"
  (cl:format cl:nil "string first~%float64 tenth~%~%~%"))
