...
class AddTwoIntsRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('tenth')) {
        this.tenth = initObj.tenth
      }
      else {
        this.tenth = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [tenth]
    bufferOffset = _serializer.float64(obj.tenth, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [tenth]
    data.tenth = _deserializer.float64(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.tenth !== undefined) {
      resolved.tenth = msg.tenth;
    }
    else {
      resolved.tenth = 0.0
    }
...
module.exports = {
  ...
  md5sum() { return '70e914cd01f6d2dbd6db72500ab2b805'; },
